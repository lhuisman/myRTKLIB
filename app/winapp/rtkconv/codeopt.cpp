...
void __fastcall TCodeOptDialog::UpdateEnable(void)
{
	...
	J60->Enabled=(NavSys&SYS_QZS)&&(FreqType&FREQTYPE_E6); //
	J34->Enabled=(NavSys&SYS_QZS)&&(FreqType&FREQTYPE_E6); //
	...
	C30->Enabled=(NavSys&SYS_CMP)&&(FreqType&FREQTYPE_E6); //
	I49->Enabled=(NavSys&SYS_IRN)&&(FreqType&FREQTYPE_E5ab);
	I50->Enabled=(NavSys&SYS_IRN)&&(FreqType&FREQTYPE_E5ab);
	I51->Enabled=(NavSys&SYS_IRN)&&(FreqType&FREQTYPE_E5ab);
	I26->Enabled=(NavSys&SYS_IRN)&&(FreqType&FREQTYPE_E5ab);
